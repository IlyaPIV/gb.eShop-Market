package gb.spring.emarket.orders.configs;


import gb.spring.emarket.orders.integrations.CartServiceIntegrationProperties;
...
public class AppConfig {
    ...
    // вместо RestTemplate подключили реактивщину
    @Bean
